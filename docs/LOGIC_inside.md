...
- **加点**: `DIRECT_STEAM_LINK` (+500), `PARENT_STEAM_LINK` (+300), `BANDCAMP_LINK` (+100), `FINGERPRINT_MATCH` (+200)。
- **減点**: `TRACK_COUNT_DIFF` (1曲につき -20, 最大 -300), `DATE_MISMATCH` (1年につき -20, 最大 -100)。
