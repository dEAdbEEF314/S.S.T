...
5. **Package**: ZIP 化して Windows 側へ転送し、`tar.exe` で展開後に ZIP を削除。
...
5. **Package**: Created as a ZIP, moved to Windows, extracted via `tar.exe`, and intermediate ZIP is deleted.
